...
api: 'POST /api/v1/consulta-cpe/factura/{id}'
---
...
const response = await fetch('https://api.yourdomain.com/api/v1/consulta-cpe/factura/123', {
  method: 'POST',
  headers: {
    'Authorization': 'Bearer {your-api-token}',
...
url = "https://api.yourdomain.com/api/v1/consulta-cpe/factura/123"
headers = {
    "Authorization": "Bearer {your-api-token}",
    "Content-Type": "application/json",
    "Accept": "application/json"
...
curl_setopt_array($curl, [
    CURLOPT_URL => "https://api.yourdomain.com/api/v1/consulta-cpe/factura/123",
